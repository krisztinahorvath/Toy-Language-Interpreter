...
public class View {
    ...
    private void runPrg1() throws StmtExeException, ADTException, ExprEvalException, DivisionByZero, IOException, InterruptedException {
    ...
    private void runPrg2() throws StmtExeException, ADTException, ExprEvalException, DivisionByZero, IOException, InterruptedException {
    ...
    private void runPrg3() throws StmtExeException, ADTException, ExprEvalException, DivisionByZero, IOException, InterruptedException {
    ...
    private void runStatement(IStatement stmt) throws ExprEvalException, StmtExeException, ADTException, DivisionByZero, IOException, InterruptedException {
        ...
        ProgramState programState = new ProgramState(executionStack, symbolTable, out, stmt, fileTable, heap);
