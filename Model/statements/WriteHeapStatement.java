...
public class WriteHeapStatement implements IStatement{
    ...
    public MyIDict<String, IType> typeCheck(MyIDict<String, IType> typeEnv) throws StmtExeException, ExprEvalException, ADTException {
        if (typeEnv.lookUp(variableName).equals(new RefType(expression.typeCheck(typeEnv))))
            return typeEnv;
        else
            throw new StmtExeException("ERROR: WriteHeap: right hand side and left hand side have different types.");
    }
